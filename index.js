...
if (!htmlFilePath && !inSituFileFolder) {
    throw new Error(`[--file=] or [--inlineall] is a required argument`);
}

if (htmlFilePath) {
    const finalOutHtml = processFile(htmlFilePath);
...
function processFile(htmlFileName) {
